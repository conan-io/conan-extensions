...
def test_append_local_build_info():
    ...
    for n in [1, 2]:
        assert ("mypkg/1.0#294e801a0e1da10084441487e95b80e8:"  # omit pkgid for multi-platform testing
                in bi_data["modules"][n]["id"] == "mypkg/1.0#294e801a0e1da10084441487e95b80e8:")
